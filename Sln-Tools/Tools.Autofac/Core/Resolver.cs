...
namespace Tools
{
	public static class Resolver
	{
		...
		public static void RegisterResolver(this ContainerBuilder builder)
		...
		public static void SetResolver(this IContainer container) => _Resolver = new ResolverContainer(container);

		/// <summary>
		/// this method is useful for mocking.
		/// </summary>
		/// <param name="resolver"></param>
		public static void SetResolverTest(this IResolver resolver) => _Resolver = resolver;
